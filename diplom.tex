...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{Ausgabe.pdf}
...
aber um eine passende grafische darstellung zu finden, muss man eine tiefgehende Kenntnis der eigenschaften
von daten haben, die es erlaubt unterschiedliche möglichkeiten der visualisierung vergleichen und die
beste finden zu können. 
...
Als Beispielzeigt abbildung x mehrere ausschnitte aus [Information is beatuiful]. diese wurden von David Maccandles
per Hand mit dem Vektorgrafikprogramm Adobe Illustrator entworfen und umgesetzt.\footnote{infoisbeautiful.net/book/process}
Da die Umsetzung in einem kreativen Design-Prozess ohne Grafikvorgaben einer Software stattgefunden hat,
unterscheiden sich die Darstellungen stark voneinander.
McCandless schreibt über seine eigene Arbeitsweise:
\begin{quote}
"`Hand-creating information designs gives you better connection to the information you're working with. It helps
you make decisions on the fly while you're drawing. Above all it's meticulous and fun. Like painting with data."'
\end{quote}

Diese Verbindung muss aufrecht erhalten werden, dem Benutzer dabei aber die Arbeit abzunehmen jeden einzelnen Datenwert
einer vermutlich großen Menge in einem Datensatz einzeln per Hand zu zeichen.
...
Eine Software entwickeln, die möglichst viele komplexe Ausgangsdaten mit möglichst vielen unterschiedlichen
graphischen Darstellungen umsetzen kann, wobei der Benutzer nicht durch Vorgaben der Anwendung eingeschränkt wird.
...
der anwender muss neben einem tiefen verständnis der zugrunde liegenden daten auch gestalterische Aspekte berücksichtigen
um eine adäquate grafische Darstellung zu finden.
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{visuelleVariablen.pdf}
\caption{visuelle Variablen nach \citep{Bertin}, Scan aus \citep[S.\,51]{Bertin}  }
