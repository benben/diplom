...
Die graphische Semiologie ist ein in BERTIN erstmals beschriebenes System zur Klassifikation von graphischen Zeichen.
Bertin geht dabei von einem monosemiotischen System aus das den rationalen Teil der Bilderwelt, also der Diagramme
als graphische Darstellung beschreibt.
Da Menschen bestimmten Zeichen unterschiedliche Bedeutungen zuordnen, muss ein "rationaler Moment" (VGL BERTIN)
...
def von schumann.
dann def von datenviz.
und  dann def von infoviz aus preim

herleitung über die wissenschaftlich-technische viz, datenviz zur informationsviz als sonderform
