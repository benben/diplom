...
die visuellen Variablen repräsentieren, greift das grundlegende
...
Experimentieren möglich. Diese kann vom Benutzer eingesetzt werden, um unkompliziert eine
Idee für die Informationsvisualisierung zu skizzieren.
Die komplexen internen Abläufe werden hinter einem intuitiven und einfachen Interface
...
\end{figure}
In der Prozesskette wird der generische Arbeitsablauf beim Benutzen
...
Die einzelnen Schritt der Prozesskette werden in Abbildung \ref{fig:prozesskette} dargestellt und im
