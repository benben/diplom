...
Daten werden im allgemeinen Bereich der Informatik als "zum Zweck der Verarbeitung
...
[http://wirtschaftslexikon.gabler.de/Archiv/54483/daten-v5.html], beschrieben. 
Damit ähnelt sich die Definition von Gabler mit der Definition des ISO 2382 Standards. 
...
SCHUMANN beschreibt ein Modell der Eigenschaften von Daten. Somit hat jeder Datensatz (als Menge von
...
In dieser Arbeit wird von Daten im allgemeinen und von Information als eigentlicher Ausdruck der Daten gesprochen.
Deshlab auch Infovis anstatt Datavis
Somit adressiert die Informationsvisualisierung einen Spezialfall der Datenvisualisierung, der
alle Anforderungen an Datenvisualisierung enthält und mit zusätztlichen Anforderungen erweitert.
