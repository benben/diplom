...
\subsection{Begriff}
Die grafische Darstellung ist das Produkt der Informationsvisualisierung. Sie besteht
...
ab, die nicht monosemiotisch\footnote{Vgl. Abschnitt \ref{sec:grafischeSemiologie}} ist. Diese Klassifikation wird weiter in Diagramme, Netze
...
der grafischen Darstellung verwendet und schließt damit alle Darstellungsformen der
...
Ein Beispiel für die Recursive-Pattern-Technik findet sich in Anhang XXX
