...
\begin{document}
\title{Konzeptfindung und prototypische Realisierung einer Software für die Informationsvisualisierung}
...
die einen physikalischen Bezugsrahmen und somit einen konkreten Ortsbezug haben. Diese Form der
...
zu physikalischen Daten existiert dabei nicht immer ein räumlicher Bezug.
Eine Aufgabe der Informationsvisualiserung ist es, diesen Ortsbezug beim Betrachter wieder gedanklich
entstehen zu lassen. Der kognitive Aufwand, der für das Verständnis der Information aus den Daten nötig ist, wird minimiert.
...
großen Datenmengen und können daher auch ohne Softwareunterstützung erstellt werden.
...
\chapter{Konzept eines Informationsvisualisierers}
\label{cha:Software}
