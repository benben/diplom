...
Publikationen hin.
Um eine für diese Arbeit sinnvolle Einteilung in Bezug auf die Informationsvisualisierung
zu finden, wird diese stark vereinfacht dargestellt und nach der Anzahl der abhängigen und
...
dieser unabhängigen Variablen größer Eins, spricht man von mehrdimensionalen Daten. Das Beispiel
...
ein Koordinatensystem beschreiben. Diese Form der Informationsvisualisierung findet häufig
...
Multiparameterdaten liegen dann vor, wenn die Anzahl der abhängigen Variablen größer Eins ist
...
Ein Beispiel für einen Datensatz ist eine Karte mit Wetterstationen, die durch ihre
...
In der wissenschaftlich-technischen Datenvisualisierung werden meist nur physikalische Daten verarbeitet.
Das können Daten über die menschliche Anatomie, das Universum oder Moleküle und Atome sein. Diese Daten
haben immer einen räumlichen Bezug.
...
spezielle form der abstrakten daten: Strukturelle Beziehungen zwischen Datenobjekten

Rein zeitbezogene Daten werden auch zu den abstrakten Daten zugeordnet. Zwar ist die Zeit eine physikalische
...
auch wenn die einfache abbildung in einem diagramm, bei der die zeit auf der x-Achse und die Höhe des Börsenwertesauf der Y-Achse
abgebildet sind, sind nur erlernte Metaphern, die ganz im Zeichen der Informationsvisualisierung versuchen
einen fehlenden räumlichen Bezug zu konstruieren.

hauptsächlich wird die infoviz genutzt um abstrakte Multiparameterdaten zu visualisieren. (letzter satz)
