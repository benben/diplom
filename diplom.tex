...
im Bereich der sozialen Netzwerke, beim Einkauf Online oder im Supermarkt, bei die Suche nach Informationen
...
Die Visualisierung als wissenschaftliches Themengebiet ist ein hochkomplexes, hochspezialisiertes Arbeitsfeld bei dem
...
Rezipienten weiterhin gewährleisten zu können. Immer komplexere Datenstrukturen können nicht mehr mit
...
der Informationsvisualisierung als eine Weiterentwicklung der technisch-wissenschaftlichen
Datenvisualisierung. Danach folgt im Abschnitt \ref{sec:Arbeitsfelder} eine Abgrenzung zu den verwandten
...
Es wird eine Transformation durchgeführt, bei der Informationen aus den reinen Daten, die zwar diese Informationen enthalten,
aber für den menschlichen Betrachter nicht erfassbar sind, in ein leicht verständliches und intuitives
Zeichensystem überführt werden.
...
Gemessene Vitalwerte wie Blutdruck oder Blutzucker einer Person können ein Beispiel für Merkmale sein.
\item[Ausprägung]
Die Ausprägung beschreibt den Wertebereich und damit alle Werte, die ein Merkmal annehmen kann.
Die Datenwerte können ein Skalar, Vektor oder Tensor sein.\footnote{Erklärung Skalar, Vektor, Tensor}
...
Für die Klassifikation von Daten gibt es keine einheitlichen Begriffe. \citep{Schumann} unterteilen die Daten
...
Außerdem kommt dem Geltungsbereich eine besondere Bedeutung zu, da dieser hier nicht
...
Projekte."'\citep{Gitta} } Dies ist ein Teilgebiet der Geographie, das erste Anwendungsgebiet der
...
\begin{itemize}
\item grafische Darstellung mit möglichst wenig Elementen, sodass die grafische Darstellung
als Ganzes mit einem Minimum an Wahrnehmungsaufwand erfasst werden kann
\item grafische Darstellung vereinfachen, ohne die Zahl der Beziehungen zu verringern
\item grafische Darstellung durch Reduzierung vereinfachen
\end{itemize}
...
die grafische Darstellung als Ziel der Informationsvisualisierung, zu konstruieren.\footnote{Eine Definition
des Begriffs "`grafische Darstellung"' erfolgt im Abschnitt \ref{sec:Darstellungen}.}
...
\item Wie kann das Verständnis von großen Datenmengen für Menschen vereinfacht werden?
